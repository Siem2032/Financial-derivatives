...
#%%
exchange.insert_order("ASML_202512_F", price= exchange.get_last_price_book("ASML_202512_F").bids[0].price, volume= 41, side="ask", order_type="ioc")
